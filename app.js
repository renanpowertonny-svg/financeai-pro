...
function applyEducationAction(action) {
  ...
  if (interventionIds.includes(action)) {
    pushEducationNotification(
      Intervenção ativa em moradia
      Identificamos que moradia está comprimindo sua margem. A intervenção aberta mostra exatamente onde ajustar para recuperar controle.
      'high'
    );
